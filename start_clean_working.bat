...
chcp 65001
echo ========================================
echo Nightingale Project Startup Script (Working Environment)
echo ========================================
echo.
...
if exist "venv_gemini\Scripts\activate.bat" (
    ...
    echo Please ensure your working environment is set up
)
cd ..
goto end
...
if exist "node_modules" (
    ...
    echo Please run option 5 to setup frontend first
)
cd ..
goto end
...
if exist "node_modules" (
    ...
    echo Warning: node_modules not found, please run option 5 to setup frontend first
)
cd ..
