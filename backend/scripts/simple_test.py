...
class SimpleTester:
    ...
    def __init__(self):
        self.output_dir = Path("simple_test_output")
    ...
    def run_single_test(self) -> Dict[str, Any]:
        ...
        try:
            ...
            output_audio_path = self.output_dir / "audio_files" / audio_filename
            ...
            print(f"  文件路径: {output_audio_path}")
            print(f"  文件大小: {os.path.getsize(output_audio_path)} bytes")
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p><strong>注意：</strong>如果音频无法播放，请点击下载链接下载音频文件到本地播放。</p>
        </div>
        ...
        <form id="evaluation-form">
            <div class="test-item">
                <div class="test-info">
                    ...
                    <p><strong>音频文件:</strong> {audio_filename}</p>
                </div>
                ...
                <div class="audio-player">
                    ...
                    <p>
                        <a href="../audio_files/{audio_filename}" download class="download-link">
                            📥 下载音频文件
                        </a>
                    </p>
                </div>
