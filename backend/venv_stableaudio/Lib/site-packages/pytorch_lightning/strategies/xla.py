...
from lightning_fabric.accelerators.xla import _XLA_AVAILABLE, _XLA_GREATER_EQUAL_2_1, _using_pjrt
...
from pytorch_lightning.plugins import XLAPrecisionPlugin
