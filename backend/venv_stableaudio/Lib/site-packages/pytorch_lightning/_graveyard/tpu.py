...
class TPUPrecisionPlugin(XLAPrecisionPlugin):
    ...
    Use :class:`~pytorch_lightning.plugins.precision.xla.XLAPrecisionPlugin` instead.

    """

    def __init__(self, *args: Any, **kwargs: Any) -> None:
        rank_zero_deprecation(
            "The `TPUPrecisionPlugin` class is deprecated. Use `pytorch_lightning.plugins.precision.XLAPrecisionPlugin`"
            " instead."
        )
...
class TPUBf16PrecisionPlugin(XLAPrecisionPlugin):
    ...
    Use :class:`~pytorch_lightning.plugins.precision.xlabf16.XLAPrecisionPlugin` instead.
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        rank_zero_deprecation(
            ...
            " `pytorch_lightning.plugins.precision.XLAPrecisionPlugin` instead."
        )
