...
if exist "venv_gemini\Scripts\Activate.ps1" (
    ...
    start powershell -NoExit -Command "cd '%CD%'; .\venv_gemini\Scripts\Activate.ps1; $env:GEMINI_API_KEY='AIzaSyAqeUjWY_u59F_Tbxm3FfE9JTJqoGMdZAI'; $env:GOOGLE_API_KEY='AIzaSyAqeUjWY_u59F_Tbxm3FfE9JTJqoGMdZAI'; python -m uvicorn app.main:app --host 0.0.0.0 --port 8000"
...
if exist "venv_stableaudio\Scripts\Activate.ps1" (
    ...
    start powershell -NoExit -Command "cd '%CD%'; .\venv_stableaudio\Scripts\Activate.ps1; $env:HF_TOKEN='your-huggingface-token-here'; python -m uvicorn app.main_stable_audio:app --host 0.0.0.0 --port 8001 --reload"
